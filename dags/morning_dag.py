...
with DAG(
    ...
    tasks[0] >> [tasks[1], tasks[3]] # Pantalon avant chaussettes
    tasks[1] >> tasks[2]             # Chaussette droite avant chaussure droite
    tasks[3] >> tasks[4]             # Chaussette gauche avant chaussure gauche
    [tasks[2], tasks[4]] >> tasks[5] # Chaussures avant sortir
